...
if (inIframe()) {
    ...
    (window._gsQueue || (window._gsQueue = [])).push(function() {
        _gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(a) {
            ...
            i.constructor = c, c.version = "1.8.0", c.API = 2, c.defaultTransformPerspective = 0, i = "px", c.suffixMap = {
                top: i,
                right: i,
                bottom: i,
                left: i,
            ...
            var G, H, I, J, K, L, j = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                M = function() {
                    ...
                    return I = -1 !== F.indexOf("Safari") && -1 === F.indexOf("Chrome") && (-1 === a || Number(F.substr(a + 8, 1)) > 3), K = I && 6 > Number(F.substr(F.indexOf("Version/index.html") + 8, 1)), J = -1 !== F.indexOf("Firefox"), /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(F), L = parseFloat(RegExp.$1), b.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>", c = b.getElementsByTagName("a")[0], c ? /^0.55/.test(c.style.opacity) : !1
                }(),
                N = function(a) {
            ...
            var gb = function(a, b, c) {
                ...
                jb = (E._setPluginRatio = function(a) {
                    ...
                    for (var f, g, h, i, b = this.data, c = b.proxy, d = b.firstMPT, e = 0.000001; d;) {
                        f = c[d.v], d.r ? f = f > 0 ? f + 0.5 >> 0 : f - 0.5 >> 0 : e > f && f > -e && (f = 0), d.t[d.p] = f, d = d._next
                    }
                ...
                mb = c.parseComplex = function(a, b, c, d, e, f, g, h, i, l) {
                    ...
                    for (o !== n.length && (m = (f || "").split(" "), o = m.length), g.plugin = i, g.setRatio = l, q = 0; o > q; q++) {
                        if (t = m[q], u = n[q], x = parseFloat(t), x || 0 === x) {
                            ...
                            if (e && ("#" === t.charAt(0) || 0 === t.indexOf("rgb") || db[t])) {
            ...
            var rb = ["scaleX", "scaleY", "scaleZ", "x", "y", "z", "skewX", "rotation", "rotationX", "rotationY", "perspective"],
                ...
                wb = function(a, b, d) {
                    ...
                    for (sb ? l = T(a, tb, b, !0) : a.currentStyle && (l = a.currentStyle.filter.match(w), l = l && 4 === l.length ? l[0].substr(4) + "," + Number(l[2].substr(4)) + "," + Number(l[1].substr(4)) + "," + l[3].substr(4) + "," + (e ? e.x : 0) + "," + (e ? e.y : 0) : null), m = (l || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], n = m.length; --n > -1;) {
                        o = Number(m[n]), m[n] = (o * h + (0 > o ? -0.5 : 0.5) >> 0) / h
                    }
                    if (16 === m.length) {
                        var y = m[8],
                            z = m[9],
                        ...
                        if (!vb || 0 === m.length || e.x !== m[4] || e.y !== m[5] || !e.rotationX && !e.rotationY) {
                            var Y = m.length >= 6,
                                Z = Y ? m[0] : 1,
                                $ = m[1] || 0,
                                _ = m[2] || 0,
                ...
                xb = function(a) {
                    ...
                    if (k) {
                        ...
                        var v, w, p = this.t.offsetWidth,
                            ...
                            t = b.x,
                            u = b.y;
                        if (null != b.ox && (v = (b.oxp ? 0.01 * p * b.ox : b.ox) - p / 2, w = (b.oyp ? 0.01 * q * b.oy : b.oy) - q / 2, t += v - (v * f + w * g), u += w - (v * h + w * i)), r) {
            ...
            pb("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective", null, function(a, b, c, d, e, g, h) {
                ...
                var n, o, p, q, r, s, t, i = d._transform = wb(a, f, !0),
                    ...
                    l = rb.length,
                    m = h;
                for ("string" == typeof m.transform && sb ? (q = j[sb], j[sb] = m.transform, n = wb(a, null, !1), j[sb] = q) : "object" == typeof m && (o = null != m.rotation ? m.rotation : null != m.rotationZ ? m.rotationZ : i.rotation * z, n = {
                ...
                if (-1 !== j.indexOf("%") != (-1 !== k.indexOf("%"))) {
                    for (l = j.split(" "), m = k.split(" "), D.setAttribute("src", T(a, "backgroundImage").replace(t, "")), n = 2; --n > -1;) {
            ...
            return i = c.prototype, i._firstPT = null, i._onInitTween = function(a, b, h) {
                ...
                if (1 !== a || this._tween._time !== this._tween._duration && 0 !== this._tween._time) {
                    if (a || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -0.000001) {
                        for (; b;) {
        ...
        if (!i.TweenLite) {
            ...
            v("Ticker", function(t, e) {
                var i, s, n, r, l, h = this,
                    ...
                    d = function(t) {
                        var e, a, o = S() - x;
                        o > p && (u += o - c), x += o, h.time = (x - u) / 1000, e = h.time - l, (!i || e > 0 || t === !0) && (h.frame++, l += e + (e >= r ? 0.004 : r - e), a = !0), t !== !0 && (n = s(d)), a && h.dispatchEvent("tick")
                    };
            ...
            r._init = function() {
                ...
                for (r in this.vars) {
                    if (_ = this.vars[r], G[r]) {
                        ...
                        if (U[r] && (l = new U[r])._onInitTween(e, this.vars[r], this)) {
                            for (this._firstPT = h = {
                                    _next: this._firstPT,
                                    t: l,
                                    p: "setRatio",
                    ...
                    if (1e-7 > t) {
                        ...
                        if (this._totalTime = this._time = t, this._easeType) {
                            var u = t / l,
                                f = this._easeType,
                                m = this._easePower;
                            (1 === f || 3 === f && u >= 0.5) && (u = 1 - u), 3 === f && (u *= 2), 1 === m ? u *= u : 2 === m ? u *= u * u : 3 === m ? u *= u * u * u : 4 === m && (u *= u * u * u * u), this.ratio = 1 === f ? 1 - u : 2 === f ? u : 0.5 > t / l ? u / 2 : 1 - u / 2
                        } else {
    ...
    (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        var t = /(\d|\.)+/g,
            ...
            s = function(s) {
                ...
                if ("number" == typeof s) {
                    return [s >> 16, 255 & s >> 8, 255 & s]
                }
                if ("#" === s.charAt(0)) {
                    return 4 === s.length && (s = "#" + s.charAt(1) + s.charAt(1) + s.charAt(2) + s.charAt(2) + s.charAt(3) + s.charAt(3)), s = parseInt(s.substr(1), 16), [s >> 16, 255 & s >> 8, 255 & s]
                }
                if ("hsl" === s.substr(0, 3)) {
                    s = s.match(t);
        ...
        _gsScope._gsDefine.plugin({
            ...
            set: function(t) {
                for (var e, i = this._firstPT; i;) {
                    e = (i.rgba ? "rgba(" : "rgb(") + (i.s + t * i.c >> 0) + ", " + (i.gs + t * i.gc >> 0) + ", " + (i.bs + t * i.bc >> 0) + (i.rgba ? ", " + (i.as + t * i.ac) : "") + ")", i.f ? this._target[i.p](e) : this._target[i.p] = e, i = i._next
                }
            }
        })
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()();
            ...
            _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                ...
                return s.version = "1.13.1", m.constructor = s, m.kill()._gc = !1, m.to = function(t, e, s, r) {
                    ...
                    var s, n, a, o, u, p = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        m = this._timeScale,
                        d = this._paused;
                    if (t >= p ? (this._totalTime = this._time = p, this._reversed || this._hasPausedChild() || (n = !0, o = "onComplete", 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (u = !0, this._rawPrevTime > r && (o = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = p + 0.0001) : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== f || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (o = "onReverseComplete", n = this._reversed), 0 > t ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (u = !0), this._rawPrevTime = t) : (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (u = !0))) : this._totalTime = this._time = this._rawPrevTime = t, this._time !== f && this._first || i || u) {
    ...
    function PlaySound(Path, sound) {
        ...
        if (navigator.userAgent.match("Firefox/index.html")) {
            audioElement.setAttribute("src",  "/static/js/alert/static/sound/" + sound + ".ogg")
        } else {
            audioElement.setAttribute("src", "/static/js/alert/static/sound/" + sound + ".mp3")
        }
        $.get();
    ...
    function CheckSpaceSB(SmallBox) {
        ...
        if (WindowWidth <= (SmallBoxWidth + 5)) {
            ...
            if (WindowWidth >= (SmallBoxOriginalWidth + 5)) {
                TweenLite.to(SmallBox, 0.3, {
                    width: SmallBoxOriginalWidth
                })
            } else {
                TweenLite.to(SmallBox, 0.3, {
                    width: (WindowWidth - 5)
    ...
    function CheckSpaceBB(BigBox) {
        ...
        if (WindowWidth <= (BigBoxWidth + 18)) {
            ...
            if (WindowWidth >= (BigBoxOriginalWidth + 18)) {
                TweenLite.to(BigBox, 0.3, {
                    width: BigBoxOriginalWidth
                })
            } else {
                TweenLite.to(BigBox, 0.3, {
    ...
    function CheckSpaceSP(MetroSidePanel) {
        ...
        if (WindowWidth < (MetroSidePanelWidth + 30)) {
            ...
            if (WindowWidth >= (MetroSidePanelOriginalWidth + 30)) {
                TweenLite.to(MetroSidePanel, 0.3, {
                    width: MetroSidePanelOriginalWidth
                })
            } else {
                TweenLite.to(MetroSidePanel, 0.3, {
    ...
    $.smallBox = function(settings, callback) {
        ...
        var SmallBox = $("#sb" + sb);
        SmallBox.attr("data-closeclick", settings.closeonclick).attr("data-posiiton", settings.position).attr("data-width", settings.width);
