/*! SmartAdmin - v1.4.0 - 2014-06-04 */ ! function(a) {
    ...
    var b = navigator.appVersion.indexOf("Mac") > -1,
            ...
            var c = new j,
                ...
                z = function(b) {
                    var c = a(document),
                        d = o(b.target),
                        e = d.editable(),
                        f = (d.codeable(), e.offset().top - c.scrollTop()),
                        g = function(a) {
        ...
        p = function() {
            {
                var c = {
                        picture: '<button type="button" class="btn btn-default" title="Resim" data-event="showImageDialog" tabindex="-1"><i class="fa fa-picture-o"></i></button>',
                        ...
                        bold: '<button type="button" class="btn btn-default" title="Kalın" data-shortcut="Ctrl+B" data-mac-shortcut="⌘+B" data-event="bold" tabindex="-1"><i class="fa fa-bold"></i></button>',
                        ...
                        underline: '<button type="button" class="btn btn-default" title="Altını Çiz" data-shortcut="Ctrl+U" data-mac-shortcut="⌘+U" data-event="underline" tabindex="-1"><i class="fa fa-underline"></i></button>',
