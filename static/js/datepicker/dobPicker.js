...
jQuery.extend({
  ...
  dobPicker: function(params) {
    ...
    if(typeof(params.dayDefault)==='undefined') params.dayDefault = 'Gün';
    if(typeof(params.monthDefault)==='undefined') params.monthDefault = 'Ay';
    if(typeof(params.yearDefault)==='undefined') params.yearDefault = 'Yıl';
